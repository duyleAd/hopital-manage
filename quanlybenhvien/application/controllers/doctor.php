...

{
	...
	/***Default function, redirects to login page if no doctor logged in yet***/
...

	{
		...
		if ($param1 == 'edit' && $param2 == 'do_update') {
			...
			redirect(base_url() . 'index.php?doctor/manage_blood_bank', 'refresh');
...

{
	...
	if ($param1 == 'create') {
		...
		redirect(base_url() . 'index.php?doctor/manage_bed', 'refresh');
...

{
...

	{
		...
		if ($param1 == 'create') {
			...
			$this->session->set_flashdata('flash_message', get_phrase('doctor_opened'));

			redirect(base_url() . 'index.php?doctor/manage_blood_donor', 'refresh');
		...
		if ($param1 == 'edit' && $param2 == 'do_update') {
			...
			$this->session->set_flashdata('flash_message', get_phrase('doctor_updated'));
		...
		if ($param1 == 'delete') {
			...
			$this->session->set_flashdata('flash_message', get_phrase('doctor_deleted'));
