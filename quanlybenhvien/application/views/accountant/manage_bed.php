		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('accountant/manage_bed/edit/do_update/'.$row['bed_id'] , array('class' => 'form-horizontal validatable'));?>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>index.php?accountant/manage_bed/edit/<?php echo $row['bed_id'];?>"
                            	...
                            	<a href="<?php echo base_url();?>index.php?accountant/manage_bed/delete/<?php echo $row['bed_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('accountant/manage_bed/create/' , array('class' => 'form-horizontal validatable'));?>
