<div class="box" style="background-image:url('uploads/img.jpg')">
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                ...
                <div class="box-content">
                	...
                	<?php foreach($edit_profile as $row):?>
						...
						<?php echo form_open('accountant/manage_bed_allotment/edit/do_update/'.$row['bed_allotment_id'] , array('class' => 'form-horizontal validatable'));?>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>index.php?accountant/manage_bed_allotment/edit/<?php echo $row['bed_allotment_id'];?>"
                            	...
                            	<a href="<?php echo base_url();?>index.php?accountant/manage_bed_allotment/delete/<?php echo $row['bed_allotment_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('accountant/manage_bed_allotment/create/' , array('class' => 'form-horizontal validatable'));?>
