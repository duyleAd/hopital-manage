		...
		<div class="container-fluid" >
			...
			<div class="nav-collapse nav-collapse-top collapse" >
				...
				<ul class="nav pull-right" >
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"  style="border-radius: 20px"><?php echo get_phrase('account');?> <b class="caret"></b></a>
				...
				<ul class="nav pull-right" >
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"  style="border-radius: 20px"><?php echo get_phrase('select_language');?><b class="caret"></b></a>
                ...
                <ul class="nav pull-right">
					...
					<a href="#"  style="border-radius: 20px" ><i class="icon-user" ></i><?php echo get_phrase($this->session->userdata('login_type')).' '.get_phrase('panel');?> </a>
